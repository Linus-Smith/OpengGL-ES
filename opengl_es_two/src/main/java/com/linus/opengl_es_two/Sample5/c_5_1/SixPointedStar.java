package com.linus.opengl_es_two.Sample5.c_5_1;
...
public class SixPointedStar {
    ...
    {
        //加载顶点着色器的脚本内容
        mVertexShader=ShaderUtil.loadFromAssetsFile("sample5_1/vertex.sh", mv.getResources());
        //加载片元着色器的脚本内容
        mFragmentShader=ShaderUtil.loadFromAssetsFile("sample5_1/frag.sh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
